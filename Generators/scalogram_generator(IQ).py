"""
==============================================================
RadioML Generator: Dual Channel (IQ)
==============================================================

Generates 2-channel scalograms.
Channel 1: In - Phase (I component)
Channel 2: Quadrature (Q component)
    ...
    for snr in snr_list:
        ...
        for mod_class in CLASSES:
            ...
            for fname in files:
                ...
                # 6. Stack Channels 
                # Returns [2, 224, 224] -> Channel 0 is I, Channel 1 is Q
                stacked = stack_channels(cwt_I, cwt_Q)
